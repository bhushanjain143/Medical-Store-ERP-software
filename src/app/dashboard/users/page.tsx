      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 p-2.5 sm:p-3.5 text-white shadow-lg overflow-hidden min-w-0">
            ...
            <p className="text-base sm:text-xl font-extrabold">{users.length}</p>
          ...
          <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 p-2.5 sm:p-3.5 text-white shadow-lg overflow-hidden min-w-0">
            <ShieldCheck className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-white/50 mb-1" />
            <p className="text-base sm:text-xl font-extrabold">{activeCount}</p>
          ...
          <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 p-2.5 sm:p-3.5 text-white shadow-lg overflow-hidden min-w-0">
            <Shield className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-white/50 mb-1" />
            <p className="text-base sm:text-xl font-extrabold">{adminCount}</p>
          ...
          <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 p-2.5 sm:p-3.5 text-white shadow-lg overflow-hidden min-w-0">
            <User className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-white/50 mb-1" />
            <p className="text-base sm:text-xl font-extrabold">{users.length - activeCount}</p>
