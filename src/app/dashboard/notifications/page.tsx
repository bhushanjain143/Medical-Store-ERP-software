      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          <div className="rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 p-4 text-white shadow-lg">
            <ShieldAlert className="h-5 w-5 text-white/50 mb-1" />
            <p className="text-xs text-white/80">Expired</p>
            <p className="text-2xl font-extrabold">{data.expiredCount}</p>
            <p className="text-[10px] text-white/60">Loss: {formatCurrency(data.totalExpiryLoss)}</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 p-4 text-white shadow-lg">
            <AlertTriangle className="h-5 w-5 text-white/50 mb-1" />
            <p className="text-xs text-white/80">Expiring Soon</p>
            <p className="text-2xl font-extrabold">{data.expiryAlerts.length}</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-amber-500 to-yellow-600 p-4 text-white shadow-lg">
            <Package className="h-5 w-5 text-white/50 mb-1" />
            <p className="text-xs text-white/80">Low Stock</p>
            <p className="text-2xl font-extrabold">{data.lowStockAlerts.length}</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-4 text-white shadow-lg">
            ...
            <p className="text-xs text-white/80">Customer Dues</p>
            <p className="text-2xl font-extrabold">{data.customerDues.length}</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 p-4 text-white shadow-lg">
            <TrendingDown className="h-5 w-5 text-white/50 mb-1" />
            <p className="text-xs text-white/80">Supplier Dues</p>
            <p className="text-2xl font-extrabold">{data.supplierDues.length}</p>
          </div>
        </div>
