      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 p-4 text-white shadow-lg">
            ...
            <p className="text-2xl font-extrabold">{formatCurrency(totalDues)}</p>
            <p className="text-xs text-white/80">Total Dues ({dueCustomers.length})</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-4 text-white shadow-lg">
            ...
            <p className="text-2xl font-extrabold">{customers.filter((c) => (c.creditLimit || 0) > 0).length}</p>
            <p className="text-xs text-white/80">Credit Accounts</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 p-4 text-white shadow-lg">
            <ShoppingCart className="h-5 w-5 text-white/50 mb-1" />
            <p className="text-2xl font-extrabold">{totalLoyalty}</p>
