    ...
    <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/60 px-4 sm:px-6 py-3 sm:py-4 sticky top-0 z-30">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
          <div className="hidden lg:flex items-center bg-slate-50/80 rounded-xl px-3.5 py-2.5 border border-slate-200/60 hover:border-indigo-200 transition-colors group">
            <Search className="h-4 w-4 text-slate-400 mr-2 group-hover:text-indigo-500 transition-colors" />
            <input
              type="text"
              placeholder="Search..."
          ...
          <button className="relative p-2 sm:p-2.5 rounded-xl hover:bg-indigo-50/80 transition-all duration-200 group">
            <Bell className="h-4 w-4 sm:h-5 sm:w-5 text-slate-500 group-hover:text-indigo-600 transition-colors" />
